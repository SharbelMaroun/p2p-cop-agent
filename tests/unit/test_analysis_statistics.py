"""`M9-06c`: summaries that carry their run count, and a paired test that cannot be faked.
...
from p2p_cop_agent.analysis import paired_compare, quantile, summarise
...
def test_quantiles_interpolate_rather_than_snapping_to_a_sample() -> None:
    """At 30-40 seeds a nearest-rank Q1 moves in steps of several percentage points, which
