"""`M8-04c` / `M8-10`: nothing grows without bound, and shutdown releases what it took.
...
def test_dropping_the_inboxes_releases_their_contents() -> None:
    """`M8-10b` asks that shutdown release every resource. The mailboxes are what this
