"""A log as a stranger's toolchain would emit it — the fixture `M8-12` turns on.

Deliberately imports nothing from `p2p_cop_agent`. It hashes with a hand-written
