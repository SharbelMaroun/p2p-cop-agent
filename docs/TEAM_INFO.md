...
| Proposed contract | PROPOSED | `0.2.10-proposed`, UNFROZEN pending independent peer acceptance. **Kept in step with `shared_contract/CONTRACT_VERSION`** — this row read `0.2.9-proposed` until 2026-08-08, one bump behind the file it describes |
