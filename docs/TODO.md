...
| M6-17 | Record the belief model in the academic report | IN PROGRESS | P1 | **Claimed by Sharbel 2026-08-06.** Bayes update, trust factor, and the Manhattan objective `[AE-42]` |
...
| M6-20 | Measure strategy quality against the baseline | IN PROGRESS | P1 | **Claimed by Sharbel 2026-08-06.** Belief-driven pursuit must beat the blind baseline or be reverted |
| M6-20a | Define the comparison protocol | IN PROGRESS | P1 | **Claimed by Sharbel 2026-08-06.** Fixed seeds, fixed opponent policy, repeated runs |
| M6-20b | Record the result either way | IN PROGRESS | P1 | **Claimed by Sharbel 2026-08-06.** A negative result is evidence, not a failure to hide |
