...
| M6-12b | Test with contradictory scent and hint | IN PROGRESS | P1 | The physical evidence wins. **Claimed by Sharbel 2026-08-06.** All three named blockers are now cleared — `M6-10`, `M6-11` and `M6-02f` are DONE — so the row is unblocked |
