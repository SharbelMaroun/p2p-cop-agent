"""SVG chart primitives for the results analysis (`M9-07b`).
...
plots for distributions". `M9-07b` adds the acceptance condition — "clear axes, legend,
...
grader uses. It also adds no third-party dependency to review and pin (`M8-09c`), and —
...
def _frame(title: str, caption: str, x_label: str, y_label: str) -> list[str]:
    """Title, caption and axis labels — `M9-07b`'s "clear axes, legend, caption"."""
    return [
