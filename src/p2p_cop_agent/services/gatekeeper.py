"""The Gatekeeper: rate limiting and overflow queueing for outbound calls (M5-05d).
...
replays. Confirmed against the reference 2026-08-01, which notes these limits are
...
from p2p_cop_agent.services.deadlines import read_limit
